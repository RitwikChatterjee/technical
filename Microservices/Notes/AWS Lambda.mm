...
<edge COLOR="#00007c"/>
<node TEXT="Language support" ID="ID_361427737" CREATED="1500595387319" MODIFIED="1500595395328">
...
<node TEXT="Golang" ID="ID_636705537" CREATED="1583444640077" MODIFIED="1583444644724"/>
</node>
...
<node TEXT="You can only specify memory" ID="ID_1891971570" CREATED="1560280037953" MODIFIED="1560280043941">
...
<node TEXT="What?" FOLDED="true" ID="ID_854629185" CREATED="1560281798682" MODIFIED="1560281800869">
...
<node TEXT="Implications" FOLDED="true" ID="ID_823570194" CREATED="1560281802017" MODIFIED="1560281806486">
<node TEXT="Request waiting for response" ID="ID_1173243666" CREATED="1560281476450" MODIFIED="1560281830662"/>
</node>
<node TEXT="Workarounds" ID="ID_31377587" CREATED="1560281833433" MODIFIED="1560281836342">
...
<node TEXT="Practical issues" FOLDED="true" ID="ID_276718546" CREATED="1500595382181" MODIFIED="1560280957388">
...
<node TEXT="Billing in 100 ms increments" ID="ID_1477233664" CREATED="1560280221841" MODIFIED="1560280228523">
...
<node TEXT="Network issue" ID="ID_474807669" CREATED="1560280506041" MODIFIED="1560280514028">
...
<node TEXT="Multi-trigger for same request" ID="ID_1658093355" CREATED="1560280675120" MODIFIED="1560280688764">
...
<node TEXT="Network?" FOLDED="true" ID="ID_350450108" CREATED="1560280478593" MODIFIED="1560280485602">
<node TEXT="Options" FOLDED="true" ID="ID_1044091109" CREATED="1560280486697" MODIFIED="1560280488732">
...
<node TEXT="Invoke" FOLDED="true" ID="ID_1430503789" CREATED="1500601053299" MODIFIED="1500601056151">
...
<node TEXT="Handler" FOLDED="true" ID="ID_1659589597" CREATED="1500601314732" MODIFIED="1500601336006">
...
<node TEXT="Context Object" FOLDED="true" ID="ID_399043344" CREATED="1500601442555" MODIFIED="1500601458910">
<node TEXT="To interact with Lambda at runtime" FOLDED="true" ID="ID_136279765" CREATED="1500601461722" MODIFIED="1500601501740">
...
<node TEXT="Runtime" ID="ID_750111513" CREATED="1549988942830" MODIFIED="1549988947317">
<node TEXT="Java 8 (as of Feb 2019)" ID="ID_1996485835" CREATED="1549988952131" MODIFIED="1549988965788"/>
</node>
<node TEXT="Deployment package" ID="ID_1580040293" CREATED="1549988890529" MODIFIED="1549988908575">
<node TEXT="zip or standalone jar" ID="ID_1296963503" CREATED="1549988914700" MODIFIED="1549988924444"/>
</node>
<node TEXT="Libraries" ID="ID_1917562827" CREATED="1549989005556" MODIFIED="1549989009643">
...
<node TEXT="context" FOLDED="true" ID="ID_367904288" CREATED="1549989210515" MODIFIED="1549989213890">
...
<node TEXT="event types" ID="ID_789458094" CREATED="1549989346918" MODIFIED="1549989353350">
...
<node TEXT="Frameworks" ID="ID_1470725016" CREATED="1581016234812" MODIFIED="1583435981724">
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#000000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1882174519" STARTINCLINATION="750;0;" ENDINCLINATION="750;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
</node>
</node>
</node>
<node TEXT="Typical usage scenarios" FOLDED="true" POSITION="right" ID="ID_1809335511" CREATED="1583511417068" MODIFIED="1583511422756">
<edge COLOR="#007c7c"/>
<node TEXT="RESTful microservices" ID="ID_954861428" CREATED="1583511423788" MODIFIED="1583511430071"/>
<node TEXT="Alexa Skills" ID="ID_1154630939" CREATED="1583511431179" MODIFIED="1583511444406"/>
<node TEXT="Mobile backend" ID="ID_881049575" CREATED="1583511451834" MODIFIED="1583511454935"/>
<node TEXT="Stream processing" ID="ID_1316326289" CREATED="1583511461974" MODIFIED="1583511465543"/>
<node TEXT="Web application" ID="ID_1378020676" CREATED="1583511466226" MODIFIED="1583511477103"/>
</node>
<node TEXT="Best practices" FOLDED="true" POSITION="right" ID="ID_1622096380" CREATED="1583512175004" MODIFIED="1583512182861">
<edge COLOR="#7c7c00"/>
<node TEXT="Separate the Lambda handler from the core logic" ID="ID_1990627693" CREATED="1583512183829" MODIFIED="1583512345345"><richcontent TYPE="NOTE">
...
<html>
  ...
  <body>
    <p>
      <font face="Courier New">public class BookPostHandler implements RequestHandler&lt;Book, String&gt; { </font>
    </p>
    <p>
      <font face="Courier New">&#160;&#160;&#160;static DynamoDBMapper mapper = DDBUtil.getMapper(); </font><font face="Courier New" color="#3333ff"><b>&lt;-- Core logic</b></font>
    </p>
    <p>
      <font face="Courier New">&#160;&#160;&#160;public String handleRequest(Book book, Context context) { </font>
    </p>
    <p>
      <font face="Courier New">&#160;&#160;&#160;&#160;&#160;System.out.println(&quot;Adding book: &quot; + book); </font>
    </p>
    <p>
      <font face="Courier New">&#160;&#160;&#160;&#160;&#160;saveBook(book); </font>
    </p>
    <p>
      <font face="Courier New">&#160;&#160;&#160;&#160;&#160;return book.getName() + &quot; saved!&quot;; </font>
    </p>
    <p>
      <font face="Courier New">&#160;&#160;&#160;} </font>
    </p>
    <p>
      <font face="Courier New">&#160;&#160;&#160;private void saveBook(Book book) { </font>
    </p>
    <p>
      <font face="Courier New">&#160;&#160;&#160;mapper.save(book); </font>
    </p>
    <p>
      <font face="Courier New">&#160;&#160;} </font>
    </p>
...
<html>
  ...
  <body>
    ...
    <p>
      &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&lt;artifactId&gt;aws-lambda-java-core&lt;/artifactId&gt; <b><font color="#000000">&lt;--- Minimal package</font></b>
    </p>
    <p>
    ...
    <p>
      &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&lt;artifactId&gt;aws-java-sdk-dynamodb&lt;/artifactId&gt; <b><font color="#000000">&lt;--- Minimal package</font></b>
    </p>
    <p>
...
<node TEXT="Delete large unused functions (75GB limit per region)" ID="ID_1941516262" CREATED="1583513183255" MODIFIED="1583513214761"/>
</node>
...
<node TEXT="AWS SAM" ID="ID_1534329152" CREATED="1583436476489" MODIFIED="1583436497445" LINK="https://github.com/awslabs/serverless-application-model"/>
</node>
